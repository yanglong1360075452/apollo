  ...
  <div class="container-wrap">
    <div class="container-box">
      ...
      <div class="container-content">
        ...
        <el-table :data="apprunnings" border stripe tooltip-effect="dark" style="width: 100%">
          <el-table-column prop="checkTime" label="时间"  align="center">
            <template slot-scope="scope">
              {{scope.row.checkTime | date}}
            </template>
          </el-table-column>
          <el-table-column prop="testEventDesc" label="事件"  align="center">
          </el-table-column>
          ...
          <el-table-column prop="appRunTotal" label="运行中APP"  show-overflow-tooltip align="center">

          </el-table-column>
          <el-table-column prop="appNameFront" label="前台APP"  align="center">
 <!--          <template scope="scope">
              {{scope.row.appNames | appName}}
            </template>-->
          </el-table-column>
  ...
  export default {
    ...
    methods: {
      ...
      fetchData (route) {
        ...
        setTimeout(() => {
          UserService.getAppRunnings({
            ...
            if (response.code == 0) {
              that.apprunnings = response.data.data;
      ...
      exportUsers: function() {
        ...
        var exportUrl=base_url +"/appRunnings/export";
        ...
        UserService.getAppRunnings(filter).then(function (response) {
          if (response.code == 0) {
