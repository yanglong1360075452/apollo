<template>
  <div class="container-wrap">
    <div class="container-box">
      ...
      <div  style="height: 30px ; margin-right: 50px"></div>
      <div style="margin-right: 50px"><h1>网络质量无障碍权限未开启的用户</h1></div>
  ...
  <!--        <el-button type="primary" size="small" @click="exportUsers()">导出</el-button>-->
        ...
        <el-table :data="users" border stripe tooltip-effect="dark" style="width: 100%">
          ...
          <el-table-column prop="testTime" label="网络质量无障碍权限未开启时间" align="center">
            <template slot-scope="scope">
  ...
  export default {
    ...
    methods: {
      ...
      fetchData (route) {
        ...
        let that = this;
        setTimeout(() => {
          UserService.getNoPermissionUsersList({
            tab: tab,
      ...
      exportUsers: function() {
        ...
        var exportUrl=base_url +"/users/exceptions/export";
        ...
        UserService.getexceptionsUsersList(filter).then(function (response) {
          if (response.code == 0) {
