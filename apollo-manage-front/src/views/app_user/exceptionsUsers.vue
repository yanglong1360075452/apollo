<template>
  <div class="container-wrap">
    <div class="container-box">
      ...
      <div style="margin-right: 50px"><h1>网络质量90分钟内没有数据记录上传的用户</h1></div>
      <div class="container-content">
        ...
        <el-table :data="users" border stripe tooltip-effect="dark" style="width: 100%">
          ...
          <el-table-column prop="testTime" label="网络质量最后测试时间" align="center">
            <template slot-scope="scope">
  ...
  export default {
    ...
    methods: {
      ...
      fetchData (route) {
        ...
        let that = this;
        setTimeout(() => {
          UserService.getexceptionsUsersList({
            tab: tab,
