<template>
  <div class="container-wrap">
    <div class="container-box">
      ...
      <div style="margin-right: 50px"><h1>网络质量24小时没有截屏的用户</h1></div>
      <div class="container-content">
        ...
        <el-table :data="users" border stripe tooltip-effect="dark" style="width: 100%">
          ...
          <el-table-column prop="testTime" label="网络质量最后截图时间" align="center">
            <template slot-scope="scope">
  ...
  export default {
    ...
    methods: {
      ...
      exportUsers: function() {
        ...
        var exportUrl=base_url +"/users/disabled/export";
        ...
        UserService.getDisabledList(filter).then(function (response) {
          if (response.code == 0) {
