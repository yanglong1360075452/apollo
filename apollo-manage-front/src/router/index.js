...
import exceptionsUsers from '../views/app_user/exceptionsUsers.vue';
import disabled from '../views/app_user/disabled.vue';
import nopermission from '../views/app_user/nopermission.vue';
import network from '../views/log/network.vue';
  ...
  routes: [
    /**首页*/
    {
      ...
      children: [
        ...
        /**app运行异常用户列表页*/
        {
          path: 'exceptionsUsers',
          component: exceptionsUsers,
          name: 'exceptionsUsers',
        },
        /**非活跃用户列表页*/
        {
          path: 'disabled',
